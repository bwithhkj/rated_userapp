...
import 'package:efood_multivendor/view/screens/restaurant/qr_scan_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
      ...
      Row(children: [
        ...
        Expanded(child: SizedBox()),
        restaurant.googleFormUrl != null
            ? InkWell(
                onTap: () =>
                    Get.to(GoogleForm(googleFormUrl: restaurant.googleFormUrl)),
                child: Column(children: [
                  Icon(Icons.money,
